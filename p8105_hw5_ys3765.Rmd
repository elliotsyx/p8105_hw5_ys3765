...
The red line is consistently above the blue line, suggesting that the average estimate of mu is slightly higher than the true mean when the null hypothesis is rejected. So it can't be equal. And the reason for this might due to type 1 error inflation, which is that 
